...
export const ja = {
  ...
  result: {
    ...
    handoff: {
      // 暫定文言（Stage 2 公開前）: 総合版側の受け取り実装が本番公開されるまで、
      // 「反映」という語を使わない。保存されるのは事実・自動反映は準備中であることを正直に示す。
      // 総合版受信側の本番公開・WordPress 実機確認の完了後に最終文言へ更新する。
      title: '生活設計に引き継ぐ',
      lead:
        'ここで整理した教育費条件を、住宅ローンや生活費・働き方と重ねて確認できます。',
      reflectButton: 'この教育費条件を保存する',
      reflectedNote: '教育費条件を保存しました。総合版への自動反映は準備中です。',
      gotoButton: '教育費条件を保存して総合版を開く',
    },
